...
# summary feature classes produced by `gfw_afe_stage_grid_summary.py`. Runs, in
# order, for each stage:
#
# 1. Add a sqrt-transformed `MonthMeanFishingHrs` field (see distribution
...
RAW_FIELD = "MonthMeanFishingHrs"      # <-- EDIT if your field name differs
SQRT_FIELD = "MMFH_sqrt"              # new field this script creates
...
ISA_NUM_DISTANCE_BANDS = 10        # <-- EDIT if you want a finer/coarser sweep
ISA_BEGINNING_DISTANCE = "1000"        # <-- EDIT: "" = auto; or set a distance in meters
ISA_DISTANCE_INCREMENT = "3000"        # <-- EDIT: "" = auto; or set a distance in meters
